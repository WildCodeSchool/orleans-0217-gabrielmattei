...
//
//                                        $res = $pdo->query("SELECT * FROM content ORDER BY year DESC ");
//
//                                        while ($resultat = $res->fetch()) {

                                            foreach ($contents as $resultat){
//                                            ?>


                                                   <tr>
                                                       <td> <?= $resultat->getTitle();
                                                   echo $resultat->getSubtitle();?> </td>
                                                       <td><?= $resultat->getYear();?></td>

                                                       <td><a href="update.php?id=<?= $resultat->getId(); ?>"><i class="material-icons">build</i> </a></td>
