...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="../../../public/adminassets/img/apple-icon.png" />
    <link rel="icon" type="image/png" href="../../../public/adminassets/img/favicon.png" />
...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="blue" data-image="../../../public/adminassets/img/sidebar-1.jpg">
        <!--
...
// initialisation de la requete et execution de la requete
                                    $pdo->exec("INSERT INTO content(title, subtitle, year, description, category) VALUES('$title', '$subtitle', '$year', '$description', '$category')");
